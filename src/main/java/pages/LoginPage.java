...
public class LoginPage extends ParentPage {
    ...
    public LoginPage checkIsRedirectLoginPage() {
        Assert.assertTrue("Login Page is not loaded", customerLoginButton.isDisplayed());
        Assert.assertTrue("Login Page is not loaded", bankManagerLoginButton.isDisplayed());
        checkUrl();
        return this;
    }
